...
- `enable_lowlevel_runtime`: Allows use of the runtime-implementation primitives. **Exclusively for `firescript/std/internal/runtime.fire`** (the firescript-implemented runtime merged into every program built with the FIR backends). Primitives:
